...
public class Config {
    ...
    public List<Config.Entry> entries = List.of(
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.ALLAY), 0.9F, 0, 40, "ALLAY"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.AXOLOTL), 0.8F, 40, "AXOLOTL"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.CAT), 1F, 0, "CAT"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.CAMEL), 1F, 0, "CAMEL"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.CAVE_SPIDER), 0.8F, 0, "CAVE_SPIDER"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.CHICKEN), 0.9F, 0, "CHICKEN"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.COD), 0.8F, 0, "COD"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.DOLPHIN), 0.7F, 0, "DOLPHIN"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.ELDER_GUARDIAN), 0.8F, 0, "ELDER_GUARDIAN"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.ENDERMITE), 1F, 0, "ENDERMITE"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.MAGMA_CUBE), 5F, 0, "MAGMA_CUBE"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.OCELOT), 0.8F, 0, "OCELOT"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.PANDA), 1.1F, 0, "PANDA"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.PLAYER), 1F, 0, 0, "PLAYER"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.SHULKER), 1.2F, 0, "SHULKER"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.SLIME), 5F, 0, "SLIME"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.SNOW_GOLEM), 1.2F, 0, "SNOW_GOLEM"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.SPIDER), 1.2F, 0, "SPIDER"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.TADPOLE), 1.2F, 0, "TADPOLE"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.TRADER_LLAMA), 1.3F, 0, "TRADER_LLAMA"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.TROPICAL_FISH), 1.4F, 0, "TROPICAL_FISH"),
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.TURTLE), 0.8F, 0, "TURTLE"),
            ...
            Entry.of(Registries.ENTITY_TYPE.getId(EntityType.ZOGLIN), 1.3F, 0, "ZOGLIN"),
